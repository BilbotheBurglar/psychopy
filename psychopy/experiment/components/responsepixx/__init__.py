...
class ResponsepixxComponent(BaseComponent):
    ...
    def writeInitCode(self, buff):
        ...
        code += "{} = ResponsePixx(pixxdevice, buttons = {}, events = [\'down\'], lights = lights)\n".format(self.params['name'], self.params["clickable"])
